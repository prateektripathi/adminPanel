...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const navigation = [
    ...
    { name: 'Staff Management', href: '/staff', icon: UserCheck, roles: ['admin'] },
    { name: 'Products/Services', href: '/products', icon: Package, roles: ['admin', 'staff'] },
    { name: 'Payments/Orders', href: '/payments', icon: CreditCard, roles: ['admin', 'staff'] },
    { name: 'Reports/Analytics', href: '/reports', icon: BarChart3, roles: ['admin', 'staff'] },
    { name: 'Bucket Management', href: '/buckets', icon: FolderOpen, roles: ['admin', 'staff'] },
    { name: 'Customer Support', href: '/support', icon: MessageCircle, roles: ['admin', 'staff'] },
  ];
